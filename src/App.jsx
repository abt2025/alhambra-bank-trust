  ...
  const renderHome = () => (
    <div className="bg-white">
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-red-700 text-center mb-12">Why Choose Alhambra Bank & Trust</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: "🏛️", title: "Regulatory Excellence", desc: "Fully licensed and regulated by CIMA" },
              { icon: "🔒", title: "Swiss-Level Privacy", desc: "Uncompromising confidentiality and discretion" },
              { icon: "🌍", title: "Global Reach", desc: "International banking with local expertise" },
              { icon: "💎", title: "Wealth Preservation", desc: "Protecting and growing your legacy" }
            ].map((feature, index) => (
              <div key={index} className="text-center p-6 bg-red-50 rounded-lg hover:shadow-lg transition-shadow">
